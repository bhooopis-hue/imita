...
await cp('worker/pricing.mjs','dist/server/pricing.mjs');
await cp('worker/country-currencies.mjs','dist/server/country-currencies.mjs');
...
await Promise.all(['api.mjs','pricing.mjs','country-currencies.mjs','assets.mjs','entry.mjs'].map(f=>rm('dist/server/'+f)));
